            ...
            <div style={{ backgroundImage: `url(${require('img/h1-parallax1.jpg')})`, padding: '50px 0' }} className="edgtf-parallax-section-holder">
                <div className="container-fluid">
                    ...
                    <div className="row d-flex edgtf-team-list-holder edgtf-team-info-on-hover">
                        {/* Grid */}
                        {attendees && attendees.map((attendee, i) => <div key={i} className="col-12 col-sm-6 col-md-4 pl-0 pr-0">
                                            ...
                                            <div className="edgtf-team-title-holder">
                                                ...
                                                <div className="edgtf-team-social-holder">
                                                    <div className="edgtf-team-social-holder-inner">
                                                        {attendee.info.facebook && <a target="_blank" href={`${attendee.info.facebook_protocol}${attendee.info.facebook}`}><span className="social_facebook_circle" aria-hidden="true"></span> </a>}
                                                        {attendee.info.twitter && <a target="_blank" href={`${attendee.info.twitter_protocol}${attendee.info.twitter}`}><span className="social_twitter_circle" aria-hidden="true"></span> </a>}
                                                        {attendee.info.linkedin && <a target="_blank" href={`${attendee.info.linkedin_protocol}${attendee.info.linkedin}`}><span className="social_linkedin_circle" aria-hidden="true"></span> </a>}
                                                        {attendee.info.website && <a target="_blank" href={`${attendee.info.website_protocol}${attendee.info.website}`}><span className="social_share_circle" aria-hidden="true"></span> </a>}
                                                    </div>
                                                </div>
                                            </div>
