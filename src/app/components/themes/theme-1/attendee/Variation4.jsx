...
const Variation4 = ({ attendees, searchBar, loadMore }) => {
  return (
    <div
      style={{
                      ...
                      <div className="edgtf-team-info">
                        <div className="edgtf-team-title-holder">
                          ...
                          {attendee.info && attendee.info.company_name && 
                            ...
                            {attendee.phone &&
                            <div className="ebs-email-phone">
                              <a href={`tel: ${attendee.phone}`} className="edgtf-team-position">
                                {attendee.phone}
                              </a>
                            </div>}
                          {attendee.info && <div className="edgtf-team-social-holder">
