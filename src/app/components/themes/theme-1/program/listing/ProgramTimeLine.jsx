...
const DataItem = ({  items, program_setting, onClick, showWorkshop }) => {
  ...
  return (
    ...
    <div title={items.topic} onClick={() => onClick(items)} style={{ left: (hours * _multiplyer)+15, width: _wrappWidth, top:`${(items.program_workshop  && showWorkshop) ? '12px' : null }` }} className={`${items.program_workshop ? 'ebs-workshop' : ''} datawrapp`}>
