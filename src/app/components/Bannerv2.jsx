...
export default class Bannerv2 extends Component {
  render() {
    return (
      <div className="main-slider-wrapper">
        ...
        <div className="slide-wrapper">
          <div style={{ backgroundImage: `url(${require('img/h1-slide1.jpg')})` }} className="background parallax-backgroud">
                ...
                <div  className="col-12 align-items-center d-flex inner-caption-wrapp">
                  <div style={{ position: 'relative' }} className="parallax-text">
                    <div className="edgtf-custom-font-holder" style={{ fontFamily: 'Rubik', fontSize: '100px', lineHeight: '115px', fontWeight: '500', textTransform: 'uppercase', textAlign: 'left', color: '#ec008c' }}>
                      2017<span style={{ color: '#fff' }}> ANNUAL TECH </span>
                    </div>
                    <div className="edgtf-custom-font-holder" style={{ fontFamily: 'Rubik', fontSize: '100px', lineHeight: '115px', fontWeight: '500', textTransform: 'uppercase', textAlign: 'left', color: '#ec008c' }}>
        ...
        <div className="slide-wrapper">
          <div style={{ backgroundImage: `url(${require('img/h1-slide2.jpg')})` }} className="background parallax-backgroud">
            <div className="caption-wrapp">
                <div  className="col-12 align-items-center d-flex inner-caption-wrapp">
                  <div style={{ position: 'relative' }} className="parallax-text">
                    <div className="edgtf-custom-font-holder" style={{ fontFamily: 'Rubik', fontSize: '100px', lineHeight: '115px', fontWeight: '500', textTransform: 'uppercase', textAlign: 'left', color: '#ec008c' }}>
                      <span style={{ color: '#fff' }}> THE NUMBER ONE</span>
                    </div>
                    <div className="edgtf-custom-font-holder" style={{ fontFamily: 'Rubik', fontSize: '100px', lineHeight: '115px', fontWeight: '500', textTransform: 'uppercase', textAlign: 'left', color: '#ec008c' }}>
                      <span style={{ color: '#fff' }}> CONVENTION  </span>
                    </div>
                    <div className="edgtf-custom-font-holder"
                      style={{ marginTop: '10px',fontFamily: 'Open Sans', fontSize: '26px', lineHeight: '37px', fontWeight: '400', letterSpacing: '0px', textAlign: 'left', color: '#ffffff' }}>
        ...
        <div className="slide-wrapper">
          <div style={{ backgroundImage: `url(${require('img/h1-parallax1.jpg')})` }} className="background parallax-backgroud">
            <div className="caption-wrapp">
                <div  className="col-12 align-items-center d-flex inner-caption-wrapp">
                  <div style={{ position: 'relative' }} className="parallax-text">
                    <div className="edgtf-custom-font-holder" style={{ fontFamily: 'Rubik', fontSize: '100px', lineHeight: '115px', fontWeight: '500', textTransform: 'uppercase', textAlign: 'left', color: '#ec008c' }}>
