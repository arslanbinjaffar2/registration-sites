                ...
                {props.alert !== "" &&<p style={{color:"green"}}>
                  ...
                  <form onSubmit={(e)=>{ e.preventDefault(); onSubmit(); }}>
                    <div className="row align-items-center">
                      ...
                      {props.settings.show_checkbox !== "0" && <div className="col-md-12">
                        <label style={{fontSize: 16}} className="ebs-accept-terms">
                      ...
                      <div className="col-md-5 offset-md-1">
                        <figure className="pb-2">
                          <Image objectFit='contain' layout="responsive" src={require('public/img/banner-subscribe.jpg')} alt="" />
                        </figure>
                      </div>
                      <div className="col-md-12 text-center pt-5">
                      <button style={{border: '2px solid #313131', color: '#313131',  fontWeight: 500}} type="submit"  disabled={props.loading ? true : false}  className="edgtf-btn edgtf-btn-huge edgtf-btn-custom-border-hover edgtf-btn-custom-hover-bg edgtf-btn-custom-hover-color rounded-pill">
