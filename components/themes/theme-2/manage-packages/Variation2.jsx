...
const Variation1 = ({ isHome }) => {
  ...
  return (
    <React.Fragment>
      {packages ? (packages.length > 0 ? <main className="ebs-manage-packages py-0" role="main">
        <div className="edgtf-parallax-section-holder ebs-bg-holder ebs-default-padding text-white text-center min-vh-100">
