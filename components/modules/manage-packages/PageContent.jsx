        ...
        <div className="ebs-header-packages">
           <div className="container">
             <div className="ebs-header-content mw-100">
              ...
              <p className='text-start'>{(event.eventsiteSettings.package_description !== undefined && event.eventsiteSettings.package_description !== "") ? event.eventsiteSettings.package_description : ""}</p>
             </div>
            </div> 
        </div>
